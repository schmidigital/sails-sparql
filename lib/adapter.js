...
module.exports = (function() {
	...
	var adapter = {
		...
		registerConnection: function(connection, collection_list, cb) {
			...
			// Stardog
			var conn = shared.connections[connection.identity].connection = new stardog.Connection();
			conn.setEndpoint(connection.endpoint);
			conn.setCredentials(connection.username, connection.password);
			conn.setReasoning(connection.reasoning);
