...
module.exports = (function() {
	...
	var adapter = {
		...
		define: function(connection, collection, definition, cb) {
			...
			// Start Query
			helper._insert(conn, triples, { graph: conn.definition }, function(err, res) {
		...
		destroy: function(connection, collection, options, values, cb) {
			...
			this.find(connection, collection, options, function(err, res) {
				...
				// Then destroy
				var triples = helper.model_to_turtle(connection, collection, res, {
					delete: true
				});
